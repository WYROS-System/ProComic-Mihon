...
def main() -> None:
    ...
    require(session, "login required to read", "English login gate detection")
    require(session, "يجب تسجيل الدخول للقراءة", "Arabic login gate detection")
    ...
    require(pro, "setOnPreferenceChangeListener", "login control must remain action-only")
    ...
    require(pro, 'putExtra("url_key", "https://procomic.pro/ar")', "direct WebView login URL extra")
    require(pro, 'putExtra("title_key", name)', "direct WebView login title extra")
